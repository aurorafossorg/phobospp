...
/** @file phobospp/core/cpuid.h
 * Detect target architecture
 * @note This file use the following syntax: PHOBOSPP_TARGET_ARCH_FAMILY_VARIANT. Can
 *	also use revision instead of variant, e.g. ARM family processors:
 *	PHOBOSPP_TARGET_ARCH_FAMILY_REVISION.
 *
...
#ifndef PHOBOSPP_CORE_CPUID_H
#define PHOBOSPP_CORE_CPUID_H
...
//Define ix86 processor architecture detection
	...
	#define PHOBOSPP_TARGET_ARCH_X86_32

	#ifdef (_M_IX86)
		#define PHOBOSPP_TARGET_ARCH_X86 (_M_IX86/100)
	#elif defined(__i686__) || defined(__athlon__) || defined(__SSE__) || defined(__pentiumpro__)
		#define PHOBOSPP_TARGET_ARCH_X86 6
	#elif defined(__i586__) || defined(__k6__) || defined(__pentium__)
		#define PHOBOSPP_TARGET_ARCH_X86 5
	#elif defined(__i486__) || defined(__80486__)
		#define PHOBOSPP_TARGET_ARCH_X86 4
	#else
		#define PHOBOSPP_TARGET_ARCH_X86 3
	#endif
...
//Define x86_64 processor architecture detection
	...
	#define PHOBOSPP_TARGET_ARCH_X86_64
	...
	//Define ARM processor wordsize
		...
		#define PHOBOSPP_TARGET_ARCH_ARM_64
	#else
		#define PHOBOSPP_TARGET_ARCH_ARM_32
	#endif
	
	//Define ARM processor version
	#if defined(__ARM_ARCH) && __ARM_ARCH > 1
		#define PHOBOSPP_TARGET_ARCH_ARM __ARM_ARCH
	#elif defined(__TARGET_ARCH_ARM) && __TARGET_ARCH_ARM > 1
		#define PHOBOSPP_TARGET_ARCH_ARM __TARGET_ARCH_ARM
	#elif defined(_M_ARM) && _M_ARM > 1
		#define PHOBOSPP_TARGET_ARCH_ARM _M_ARM
	#elif defined(__ARM64_ARCH_8__) || defined(__aarch64__) || defined(__ARMv8__) || defined(__ARMv8_A__)
		#define PHOBOSPP_TARGET_ARCH_ARM 8
	#elif defined(__ARM_ARCH_7__) || defined(__ARM_ARCH_7A__) || defined(__ARM_ARCH_7R__) \
		|| defined(__ARM_ARCH_7M__) || defined(__ARM_ARCH_7S__) || defined(_ARM_ARCH_7) || defined(__CORE_CORTEXA__)

		#define PHOBOSPP_TARGET_ARCH_ARM 7
		...
		#define PHOBOSPP_TARGET_ARCH_ARM 6
	#elif defined(__ARM_ARCH_5TEJ__) || defined(__ARM_ARCH_5TE__)
		#define PHOBOSPP_TARGET_ARCH_ARM 5
	#elif defined(__ARM_ARCH_4T__) || defined(__TARGET_ARM_4T)
		#define PHOBOSPP_TARGET_ARCH_ARM 4
	#elif defined(__ARM_ARCH_3M__) || defined(__ARM_ARCH_3__)
		#define PHOBOSPP_TARGET_ARCH_ARM 3
	#elif defined(__ARM_ARCH_2__)
		#define PHOBOSPP_TARGET_ARCH_ARM 2
	#else
		#define PHOBOSPP_TARGET_ARCH_ARM 0
	#endif
	
	//ARM version alias
	#if PHOBOSPP_TARGET_ARCH_ARM >= 8
		#define PHOBOSPP_TARGET_ARCH_ARM_V8
	#endif
	#if PHOBOSPP_TARGET_ARCH_ARM >= 7
		#define PHOBOSPP_TARGET_ARCH_ARM_V7
	#endif
	#if PHOBOSPP_TARGET_ARCH_ARM >= 6
		#define PHOBOSPP_TARGET_ARCH_ARM_V6
	#endif
	#if PHOBOSPP_TARGET_ARCH_ARM >= 5
		#define PHOBOSPP_TARGET_ARCH_ARM_V5
	#endif
	#if PHOBOSPP_TARGET_ARCH_ARM >= 4
		#define PHOBOSPP_TARGET_ARCH_ARM_V4
	#endif
	#if PHOBOSPP_TARGET_ARCH_ARM >= 3
		#define PHOBOSPP_TARGET_ARCH_ARM_V3
	#endif
	#if PHOBOSPP_TARGET_ARCH_ARM >= 2
		#define PHOBOSPP_TARGET_ARCH_ARM_V2
	#else
...
//Define PowerPC processor architecture family
	...
	#ifdef _ARCH_440
		#define PHOBOSPP_TARGET_ARCH_POWERPC 440
	#elif _ARCH_450
		#define PHOBOSPP_TARGET_ARCH_POWERPC 450
	#elif (_M_PPC == 601) || defined(__ppc601__) || defined(_ARCH_601)
		#define PHOBOSPP_TARGET_ARCH_POWERPC 601
	#elif (_M_PPC == 603) || defined(__ppc603__) || defined(_ARCH_603)
		#define PHOBOSPP_TARGET_ARCH_POWERPC 603
	#elif (_M_PPC == 604) || defined(__ppc604__) || defined(_ARCH_604)
		#define PHOBOSPP_TARGET_ARCH_POWERPC 604
	#elif (_M_PPC == 620)
		#define PHOBOSPP_TARGET_ARCH_POWERPC 620
	#else
		#define PHOBOSPP_TARGET_ARCH_POWERPC
	#endif

	#if defined(__ppc64__) || defined(__powerpc64__) || defined(__64BIT__)
		#define PHOBOSPP_TARGET_ARCH_POWERPC_64
	#else
		#define PHOBOSPP_TARGET_ARCH_POWERPC_32
	#endif

//Define SPARC processor architecture family
#elif defined(__sparc) || defined(__sparc__)
	#define PHOBOSPP_TARGET_ARCH_SPARC
	#ifdef __sparc_v9__
		#define PHOBOSPP_TARGET_ARCH_SPARC_V9
	#endif
	#ifdef __sparc64__
		#define PHOBOSPP_TARGET_ARCH_SPARC_64
	#endif

//Define s390 processor architecture family
#elif defined(__s390__)
	#define PHOBOSPP_TARGET_ARCH_S390
	#ifdef __s390x__
		#define PHOBOSPP_TARGET_ARCH_S390_X
	#endif
...
*/
	...
	#define PHOBOSPP_TARGET_ARCH_ALPHA
	#ifdef __alpha_ev4__
		#define PHOBOSPP_TARGET_ARCH_ALPHA_EV4
	#endif
	#ifdef __alpha_ev5__
		#define PHOBOSPP_TARGET_ARCH_ALPHA_EV5
	#endif
	#ifdef __alpha_ev6__
		#define PHOBOSPP_TARGET_ARCH_ALPHA_EV6
	#endif
#elif defined(__bfin) || defined(__BFIN__)
	#define PHOBOSPP_TARGET_ARCH_BLACKFIN
	...
	#define PHOBOSPP_TARGET_ARCH_CONVEX
	#ifdef __convex_c1__
		#define PHOBOSPP_TARGET_ARCH_CONVEX_C1
	#endif
	#ifdef __convex_c2__
		#define PHOBOSPP_TARGET_ARCH_CONVEX_C2
	#endif
	#ifdef __convex_c32__
		#define PHOBOSPP_TARGET_ARCH_CONVEX_C32
	#endif
	#ifdef __convex_c34__
		#define PHOBOSPP_TARGET_ARCH_CONVEX_C34
	#endif
	#ifdef __convex_c38__
		#define PHOBOSPP_TARGET_ARCH_CONVEX_C38
	#endif
#elif defined(__epiphany__)
	#define PHOBOSPP_TARGET_ARCH_EPIPHANY
	...
	#define PHOBOSPP_TARGET_ARCH_PA_RISC
	#ifdef _PA_RISC1_0
		#define PHOBOSPP_TARGET_ARCH_PA_RISC_1_0
	#endif
	#if defined(_PA_RISC1_1) || defined(__HPPA11__) || defined(__PA7100__)
		#define PHOBOSPP_TARGET_ARCH_PA_RISC_1_1
	#endif
	#if defined(_PA_RISC2_0) || defined(__RISC2_0__) || defined(__HPPA20__) || defined(__PA8000__)
		#define PHOBOSPP_TARGET_ARCH_PA_RISC_2_0
	#endif
	...
	|| defined(__mc68040__) || defined(__mc68060__)
		...
		#define PHOBOSPP_TARGET_ARCH_MC68K 68000
	#elif defined(__mc68010__)
		#define PHOBOSPP_TARGET_ARCH_MC68K 68010
	#elif defined(__mc68020__) || defined(__MC68020__)
		#define PHOBOSPP_TARGET_ARCH_MC68K 68020
	#elif defined(__mc68030__) || defined(__MC68030__)
		#define PHOBOSPP_TARGET_ARCH_MC68K 68030
	#elif defined(__mc68040__)
		#define PHOBOSPP_TARGET_ARCH_MC68K 68040
	#elif defined(__mc68060__)
		#define PHOBOSPP_TARGET_ARCH_MC68K 68060
	#else
		#define PHOBOSPP_TARGET_ARCH_MC68K
	#endif
#elif defined(__sh__)
	#define PHOBOSPP_TARGET_ARCH_SUPERH
	#ifdef __sh1__
		#define PHOBOSPP_TARGET_ARCH_SUPERH_1
	#endif
	#ifdef __sh2__
		#define PHOBOSPP_TARGET_ARCH_SUPERH_2
	#endif
	#if defined(__sh3__) || defined(__SH3__)
		#define PHOBOSPP_TARGET_ARCH_SUPERH_3
	#endif
	#ifdef __SH4__
		#define PHOBOSPP_TARGET_ARCH_SUPERH_4
	#endif
	#ifdef __SH5__
		#define PHOBOSPP_TARGET_ARCH_SUPERH_5
	#endif
	...
	|| defined(_TMS320C6X) || defined(__TMS320C6X__)
		...
		#define PHOBOSPP_TARGET_ARCH_TMS320 2000
	#elif defined(_TMS320C5X) || defined(__TMS320C55X__)
		#define PHOBOSPP_TARGET_ARCH_TMS320 5000
	#elif defined(_TMS320C6X) || defined(__TMS320C6X__)
		#define PHOBOSPP_TARGET_ARCH_TMS320 6000
	#endif

	#if defined(_TMS320C28X)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C28XX
	#elif defined(_TMS320C5XX)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C54X
	#elif defined(__TMS320C55X__)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C55X
	#elif defined(_TMS320C6200)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C6200
	#elif defined(_TMS320C6400)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C6400
	#elif defined(_TMS320C6400_PLUS)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C6400_PLUS
	#elif defined(_TMS320C6600)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C6600
	#elif defined(_TMS320C6700)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C6700
	#elif defined(_TMS320C6700_PLUS)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C6700_PLUS
	#elif defined(_TMS320C6740)
		#define PHOBOSPP_TARGET_ARCH_TMS320_C6740
	#endif
#elif defined(__TMS470__)
	#define PHOBOSPP_TARGET_ARCH_TMS470
#else
...
// __ILP32__ 	Defined by GNU C
	...
	#define PHOBOSPP_TARGET_DATAMODEL_ILP32

// _LP64 		Defined by HP aCC and Sun Studio
// __LP64__ 	Defined by GNU C
#elif defined(__LP64__) || defined(_LP64)
	#define PHOBOSPP_TARGET_DATAMODEL_LP64
#endif

//Define wordsize
#if defined(PHOBOSPP_TARGET_CPUARCH_86_64) && !defined(PHOBOSPP_TARGET_DATAMODEL_ILP32)
	#define PHOBOSPP_TARGET_WORDSIZE 64
#else
	#define PHOBOSPP_TARGET_WORDSIZE 32
#endif



#endif // PHOBOSPP_CORE_CPUID_H